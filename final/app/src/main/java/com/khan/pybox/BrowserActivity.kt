...
class BrowserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.nav_forward_button).setOnClickListener {
            if (webView.canGoForward()) webView.goForward()
        }
        findViewById<Button>(R.id.nav_reload_button).setOnClickListener { webView.reload() }
        findViewById<Button>(R.id.nav_home_button).setOnClickListener { navigate("https://www.google.com") }

        // Back button steps back through this WebView's browsing history
        // first (like Chrome does), only closing the screen once there's
        // no earlier page to return to.
